...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        last_version=$1
        url="https://github.com/kyccyyds/XrayR/releases/download/${last_version}/XrayR-linux-64.zip"
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/kyccyyds/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
